...
def run_skeletons_pca(root_directory: str, save_intermediate_data: bool = False):
    ...
    video_filenames = [f for f in os.listdir(input_joints_folder) if f.endswith('.npy')]
    ...
    for filename_index, video_filename in enumerate(video_filenames):
        ...
        skeleton_animation_filepath = os.path.join(input_joints_folder, video_filename)
    ...
    for video_filename, skeleton_animation in zip(video_filenames, skeletons_animations):
        ...
        current_output_filepath = os.path.join(output_joints_pca_folder, video_filename)
...
if __name__ == '__main__':
    root_folder = '/home/anton/work/fitMate/datasets/train_mix_squad_1.0'

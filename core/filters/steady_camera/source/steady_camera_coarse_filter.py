...
from core.filters.steady_camera.source.image_registration.image_registration_poc import ImageSequenceRegistrationPoc
from core.filters.steady_camera.source.persons_mask.persons_mask_base import PersonsMaskBase
from core.filters.steady_camera.source.ocr.ocr_base import OcrBase
...
class SteadyCameraCoarseFilter:
    ...
    def _calculate_poc_resolution(self) -> None:
        ...
        """
        poc_scale_factor = self.poc_maximum_image_dimension / max(self.video_frames_batch.video_properties.resolution)

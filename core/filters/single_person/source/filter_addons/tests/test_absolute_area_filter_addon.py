...
class TestAbsoluteAreaFilterAddon(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.area_values_range = 180, 700
    ...
    def generate_person_tracked_data(self, frames_indices: np.ndarray, bounding_boxes_mean: int, tracks: MultiplePersonsTracks) -> PersonTrackedData:

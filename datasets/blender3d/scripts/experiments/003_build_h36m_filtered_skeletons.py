...
def create_skeleton_video_sample(videos_folder: str, joints_3d_animations_folder: str, video_filename: str, joints_skeleton_material: any) -> Type[bpy.context.active_object]:
    ...
    skeleton_animation_curves = np.load(joints_filepath)
    ...
    joints_animation_coordinate_frame.data['pca'] = 0.0
...
def main():
    ...
    for video_index, video_filename in enumerate(video_filenames):
        ...
        sample_frame = create_skeleton_video_sample(videos_folder, joints_3d_folder, video_filename, joints_skeleton_material)
